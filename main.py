...
class CoinPaymentsAPI:
    ...
    def api_call(self, cmd, req={}):
        ...
        hmac_value = hashlib.sha512(post_data.encode('utf-8'), self.private_key.encode('utf-8')).hexdigest()
        req['HMAC'] = hmac_value

        response = requests.post('https://www.coinpayments.net/api.php', data=req)
